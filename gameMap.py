...
from config import CELL_COLOR, SIZE_CELL, VISITED_COLOR, TREASURE_COLOR, MUMMY_COLOR, PLAYER_COLOR, MARGIN, \
    BACKGROUND_COLOR
        ...
        if 0 <= new_pos[0] < len(self.listCells) and 0 <= new_pos[1] < len(self.listCells):
            ...
            if not cell.is_hole:  # Evitar celdas con agujeros
                ...
                if cell.has_treasure:
                    print("¡Has ganado la partida!")  # Mensaje en consola (para debug)
